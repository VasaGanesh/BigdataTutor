...
def chatbot_response():
    print('CHATBOT ENTERED')
    data = request.json
    print( data )
    user_message = data.get("message", "")

    prompt = f"""
    You are a smart educational assistant for a workflow-building app called BigDataTutor.
    The user is a student trying to build and debug workflows using PySpark.

    Student says: {user_message}

    Provide a helpful, clear, and actionable response that could involve:
    - Explaining how to use nodes or statements
    - Structuring a workflow
    - Debugging Spark/PySpark code
    - Suggesting improvements or best practices
    - Helping understand data/control flow
    """
